...
public class peraccount {
    ...
    public String getPeracbalance() {
        return peracbalance;
    }

    public void setPeracbalance(String peracbalance) {
        this.peracbalance = peracbalance == null ? null : peracbalance.trim();
    }

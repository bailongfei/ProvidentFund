        ...
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
            ...
            <div class="layui-input-block">
             <input type="text" id="ids" name="UnitInfoName" placeholder="请输入单位名称" autocomplete="off" class="layui-input">
             <!-- <input  type="text"    id="bjType" name="" placeholder="请输入业务类型"  > -->
             
             <input style="text-align:right;"  type="date"    id="date1" name=""  >至<input style="text-align:right;"  type="date"    id="date2" name=""  >
            </div>
          </div>

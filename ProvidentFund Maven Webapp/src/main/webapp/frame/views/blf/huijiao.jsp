...
<body>
 ...
 <!-- <a href="ProvidentFund/frame/views/blf/huijiaomingxi.jsp">汇缴明细</a>  -->
<button class="btn btn-primary" id="hjmx" onclick="hjmxcx(1)" data-toggle="modal" data-target="#myModal1s">补缴明细查询</button>
<ul class="pager" >
 	<li>
...
<!-- 模态框（Modal） -->
<div class="modal fade" id="myModal1s" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content" style="width: 800px;">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel" >
					单位信息:<input  type="text"    id="ids" name="UnitInfoName" placeholder="请输入单位名称"  ><button id="btnmx" onclick="hjmxcx(1)" class="btn btn-info btn-xs">检索</button><input style="text-align:right;"  type="date"    id="date1" name=""  >至<input style="text-align:right;"  type="date"    id="date2" name=""  >
				</h4>
			</div>
			<div class="modal-body">
...
//汇缴月数 
 ...
 /* $(document).on("click","#hjmx",function(){

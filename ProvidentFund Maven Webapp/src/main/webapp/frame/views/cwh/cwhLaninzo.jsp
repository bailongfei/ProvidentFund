...
<html>
  ...
  <div style="text-align:center;font-size:40px;font-weight:bold;margin-bottom:20px;margin-top:20px;"><span style="color:#000">贷款最终审核</span></div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="col-sm-10">
			<input     type="text" class="form-control"  name="name" id="bkname"><br>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input    type="text"  name="dkzh"class="form-control"  id="hkzh" ><br>
		</div>
	</div>
	<div class="form-group">
		<label for="fiename" class="col-sm-2 control-label">贷款金额</label>
		<div class="col-sm-10">
			<input    type="text"  name="dkffe"class="form-control"  id="dkje" ><br>
		</div>
	</div>
	<div class="form-group">
	 ...
	 <div class="form-group">
		<label for="fiename" class="col-sm-2 control-label">期数</label>
		<div class="col-sm-10">
			<input    type="text"  name="hsbjze"class="form-control"  id="grdkqs" ><br>
		</div>
	</div>
	<div class="form-group">
		<label for="fiename" class="col-sm-2 control-label">还款期数</label>
		<div class="col-sm-10">
			<input    type="text"  name="dksyqs"class="form-control"  id="grdkqs1" >
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input    type="text"  name="zxll"class="form-control"  id="jkhtll" ><br>
		</div>
	</div>
	<div class="form-group">
            ...
            $.ajax({      
                ...
                $("#dkxxbh").val(data[0].dkxxbh);
                    ...
                    $("#shtype").val(data[0].shtype);
                     $("#grdkqs").val(data[0].grdkqs);
                    $("#grdkqs1").val(data[0].grdkqs); 
			...
			$.ajax({
	           ...
	           data:$("#form2").serialize(),
	        	...
	        	success : function(data) {
	        		alert(data);
	        		//test();
/*    window.location.href = "/frame/views/cwhloanin.jsp";	 

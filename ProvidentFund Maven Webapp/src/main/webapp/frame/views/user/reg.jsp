				...
				<form id="regForm" method="post">
					...
					<div class="layui-form-item">
						<label
							...
							name="password" id="LAY-user-login-password" lay-verify="pass"
					...
					<div class="layui-form-item">
						<label
							...
							for="LAY-user-login-repass"></label> <input type="password"
							 id="LAY-user-login-repass" lay-verify="required"
					...
					<div class="layui-form-item">
						<button class="layui-btn layui-btn-fluid" lay-submit
							lay-filter="LAY-user-reg-submit" onclick="reg()">注 册</button>
					</div>
				</form>
...
<script>
	function reg(){
		...
		alert(obj.toString());
		$.ajax({
			url:"${pageContext.request.contextPath}/login/regUser",
			type:"post",

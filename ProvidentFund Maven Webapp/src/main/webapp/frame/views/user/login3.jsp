			...
			<form id="loginForm" class="layui-form" method="post">
				...
				<div
					...
					<div class="layui-form-item">
						<label
							class="layui-form-label"></label> <input type="text"
							name="userName" id="LAY-user-login-username"
							lay-verify="name" placeholder="用户名" class="layui-input">
					</div>
					<div class="layui-form-item">
						<label
							...
							lay-verify="pwd" placeholder="密码" class="layui-input">
					</div>
          ...
          <a href="forget.html" class="layadmin-user-jump-change layadmin-link" style="margin-top: 7px;">忘记密码？</a>
					...
					<div class="layui-form-item">
						<button class="layui-btn layui-btn-fluid" lay-submit
							lay-filter="LAY-user-login-submit" onclick="login()">登 入</button>
					</div>

					...
					<ul class="layui-nav layui-nav-tree" lay-shrink="all"
						...
						<li data-name="component" class="layui-nav-item"><a
							...
							<dl class="layui-nav-child">
								...
								<dd data-name="table" class="layui-nav-itemed">
						...
						<li data-name="template" class="layui-nav-item"><a
							...
							<dl class="layui-nav-child">
								...
								<dd>
									<a lay-href="http://www.baidu.com/">百度一下</a>
								</dd>
								<dd>
									<a lay-href="http://www.layui.com/">layui官网</a>
								</dd>
								<dd>
									<a lay-href="http://www.layui.com/admin/">layuiAdmin官网</a>
								</dd>
							</dl></li>
						...
						<li data-name="template" class="layui-nav-item"><a
							...
							<dl class="layui-nav-child">
								<dd>
									<a lay-href="index1.jsp">系统登录</a>
								</dd>
								<dd>
									<a lay-href="index2.jsp">未认证用户注册</a>
								</dd>
								<dd>
									<a lay-href="index3.jsp">未认证用户登录</a>
								</dd>
								<dd>
									<a lay-href="index4.jsp">登记开户</a>
								</dd>
								<dd>
									<a lay-href="index5.jsp">单位开户</a>
								</dd>
								<dd>
									<a lay-href="index6.jsp">添加经办人信息</a>
								</dd>
							</dl></li>
						<!-- ******************************************************************* -->
						<!-- ****************************新加的left****************************** -->

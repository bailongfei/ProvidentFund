      ...
      <div class="layui-card-body" style="padding: 10px;">
        <form class="layui-form" id="tbody" lay-filter="component-form-group">
		 ...
		 <label class="layui-form-label">姓名</label>
              <div class="layui-input-inline">
                <input type="tel" id="grname" name="bkname" readonly="readonly"  autocomplete="off" class="layui-input">
              </div>
		 ...
		 <div class="layui-form-item">
      	...
      	<label class="layui-form-label">手机号</label>
            ...
            <label class="layui-form-label">月收入</label>
              	<div class="layui-input-inline">
                <input type="tel" id="incomes"  name="monthlyProfit" autocomplete="off" class="layui-input">
             	 </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" id="unitaa" name="dwzh" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input">
            </div>
          </div>
            ...
            <label class="layui-form-label">还款账号</label>
              <div class="layui-input-inline">
                <input type="tel" id="hkkk"  name="hkzh"  autocomplete="off" class="layui-input">
                    </div>
              </div>
...
<div class="layui-fluid" id="box3" style="display:none">
 <div class="layui-card">
			 <div class="layui-card-header">购房表</div>			 
			   <div class="layui-card-body" style="padding: 15px;">
   <form id="type2"  class="form-horizontal" role="form" lay-filter="component-form-group">
